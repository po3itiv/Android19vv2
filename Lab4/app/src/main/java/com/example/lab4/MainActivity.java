...
public class MainActivity extends Activity {
    ...
    int newNumber = numberOfRemainingLoginAttempts;
    ...
    protected void onStop(){
        ...
        editor.putString("log", ""+ username.getText().toString());
    ...
    protected void onStart(){
        username.setText(sharedPref.getString("log", ""));
    ...
    public void Login(View view) {
        ...
        if (username.getText().toString().equals("oleg") &&
            ...
            String Chislo =  String.valueOf(newNumber - numberOfRemainingLoginAttempts);
